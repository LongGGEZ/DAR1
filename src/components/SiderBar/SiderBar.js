        ...
        <ul className="siderbar">
          ...
          <li className="siderbar-menu">
            <NavLink activeclassname="active" to="/rank">
              <img
                src="https://img.icons8.com/external-smashingstocks-glyph-smashing-stocks/48/000000/external-ranking-sports-and-awards-smashingstocks-glyph-smashing-stocks.png"
                alt="Rank Movie"
              />
              Xếp hạng phim
            </NavLink>
